...
q_min = np.array([
    ...
    # Left leg
    -3.14, -3.14, -3.14, -3.14, -3.14, -3.14,
    # Right arm (shoulder_pitch, shoulder_roll, shoulder_yaw, elbow_pitch, elbow_yaw, wrist_pitch, wrist_yaw)
    -np.pi, -np.pi, -np.pi, -np.pi/3, -np.pi, -2*np.pi/3, -np.pi,
    # Left arm
    -np.pi, -0.5, -np.pi, -np.pi/3, -np.pi, -2*np.pi/3, -np.pi,
    # Head
    -3.14, -3.14
], dtype=np.float32)
...
q_max = np.array([
    ...
    3.14, 3.14, 3.14, 3.14, 3.14, 3.14,
    # Right arm (shoulder_pitch, shoulder_roll, shoulder_yaw, elbow_pitch, elbow_yaw, wrist_pitch, wrist_yaw)
    np.pi, 0.5, np.pi, np.pi/2, np.pi, 2*np.pi/3, np.pi,
    # Left arm
    np.pi, np.pi, np.pi, np.pi/2, np.pi, 2*np.pi/3, np.pi,
    # Head
    3.14, 3.14
], dtype=np.float32)
